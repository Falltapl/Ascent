...
export type Chunk = { type: 'thinking' | 'text' | 'done'; value: string }
/** Shared effort scale, mapped onto each provider's own knob. */
 ...
 */
export const SYSTEM = `You are the study assistant built into Ascent, a personal dashboard that tracks goals, AWS certification progress, and university coursework.
...
export function studyContext(): string {
